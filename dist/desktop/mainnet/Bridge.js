...
class Bridge {
    ...
    download(data) {
        return new Promise((resolve, reject) => {
            ...
            return electron_1.dialog.showSaveDialog(this.main.mainWindow, options).then(function (saveDialogValue) {
                if (saveDialogValue.filePath) {
                    return utils_1.write(saveDialogValue.filePath, data.fileContent).then(resolve, reject);
                }
                else {
