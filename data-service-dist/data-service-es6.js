...
function getAliasesByIdList(ids) {
    var ds = config_1.getDataService();
    return request_1.request({ method: function () { return ds.aliases.getByIdList(ids); } }).then(function (r) { return r.data; });
}
...
var DataManager = /** @class */ (function () {
    ...
    DataManager.prototype.getOracleAssetDataByOracleName = function (id, oracleName) {
        ...
        var gateways = (_a = {},
            ...
            _a[WavesApp.defaultAssets.WEST] = true,
...
var validateIdList = function (idList) {
...
var createRequestForIdList = function (rootUrl) { return function (idList) {
