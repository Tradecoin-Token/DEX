...
(function (f) {
    ...
    var define, module, exports;return function () {
        function r(e, n, t) {
            ...
            var matchersApi = require("./matchers/matchers");
            ...
            exports.aliases = { getAliasesByAddress: aliases_1.getAliasesByAddress, getAddressByAlias: aliases_1.getAddressByAlias, getAliasesByIdList: aliases_1.getAliasesByIdList };
        ...
        }, { "../utils/AssetStorage": 27, "../utils/request": 32, "../utils/utils": 33, "./address": 2, "./aliases/aliases": 3, "./assets/assets": 4, "./data": 5, "./matcher/getLastPrice": 6, "./matcher/getOrders": 7, "./matcher/getSettings": 8, "./matcher/orderBook": 9, "./matchers/matchers": 10, "./node/node": 11, "./pairs/pairs": 12, "./rating/rating": 13, "./transactions/parse": 14, "./transactions/transactions": 15 }], 2: [function (require, module, exports) {
            "use strict";
            ...
            function getScriptInfo(address) {
                return Promise.all([assets_1.get('WAVES'), request_1.request({ url: config_1.get('node') + "/addresses/scriptInfo/" + address })]).then(function (_a) {
                    var asset = _a[0],
                        info = _a[1];
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../assets/assets": 4, "@waves/data-entities": undefined }], 3: [function (require, module, exports) {
            "use strict";
            ...
            function getAliasesByIdList(ids) {
                var ds = config_1.getDataService();
                return request_1.request({ method: function method() {
                        return ds.aliases.getByIdList(ids);
                    } }).then(function (r) {
                    return r.data;
                });
            }
            exports.getAliasesByIdList = getAliasesByIdList;
        }, { "../../config": 21, "../../utils/request": 32 }], 4: [function (require, module, exports) {
            "use strict";
            ...
            function get(assets) {
                return AssetStorage_1.assetStorage.getAssets(utils_1.toArray(assets), getAssetRequestCb).then(function (list) {
                    ...
                    var rewriteAssets = config_1.get('rewriteAssets') || {};
                    ...
                    return list.map(function (asset) {
                        ...
                        Object.entries(rewriteAssets[asset.id]).forEach(function (_a) {
                            var key = _a[0],
                                value = _a[1];
            ...
            function getNftList(address, limit) {
                return request_1.request({
                    url: config_1.get('node') + "/assets/nft/" + address + "/limit/" + limit
                });
            }
            ...
            function wavesBalance(address) {
                return Promise.all([get(signature_adapter_1.WAVES_ID), request_1.request({ url: config_1.get('node') + "/addresses/balance/details/" + address })]).then(function (_a) {
                    var waves = _a[0],
                        details = _a[1];
            ...
            function getAssetsByBalanceList(data) {
                return get([signature_adapter_1.WAVES_ID].concat(data.balances.map(function (balance) {
            ...
            var getAssetRequestCb = function getAssetRequestCb(list) {
                ...
                .then(function (response) {
                    ...
                    return queueRequest(fails).then(function (reloadedAssets) {
                        var failCount = 0;
        ...
        }, { "../../config": 21, "../../utils/AssetStorage": 27, "../../utils/request": 32, "../../utils/utils": 33, "@waves/bignumber": undefined, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined, "ts-utils": undefined }], 5: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32, "@waves/oracle-data": undefined, "ramda": undefined }], 6: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32, "@waves/bignumber": undefined, "@waves/data-entities": undefined }], 7: [function (require, module, exports) {
            "use strict";
            ...
            function getOrders(options) {
                ...
                return fetch("orderbook/" + signatureData.publicKey + "?activeOnly=" + activeOnly).then(exports.parse);
            }
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../../utils/utils": 33, "../assets/assets": 4, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined, "ts-utils": undefined }], 8: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32 }], 9: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../../utils/utils": 33, "../pairs/pairs": 12, "@waves/bignumber": undefined, "@waves/data-entities": undefined }], 10: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../../utils/utils": 33 }], 11: [function (require, module, exports) {
            "use strict";
            ...
            exports.time = time;
        }, { "../../config": 21, "../../utils/request": 32 }], 12: [function (require, module, exports) {
            "use strict";
                ...
                return function (list) {
                    return pairs.map(function (pair, index) {
                        ...
                        var change24F = function change24F(open, close) {
                            return !open || open.eq(0) || !close ? new bignumber_1.BigNumber(0) : close.sub(open).div(open).mul(100).roundTo(2);
                        };
            ...
            function info(matcher, pairs) {
                return Promise.all([assets_1.get(signature_adapter_1.WAVES_ID), request_1.request({ method: function method() {
                        return config_1.getDataService().getPairs(matcher)(pairs).then(function (response) {
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../assets/assets": 4, "@waves/assets-pairs-order": 35, "@waves/bignumber": undefined, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined }], 13: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../../config": 21, "../../utils/request": 32, "../../utils/utils": 33 }], 14: [function (require, module, exports) {
            "use strict";
            ...
            function parseTx(transactions, isUTX, isTokens) {
                ...
                }), api && api.getPublicKey() || Promise.resolve(null), api && api.getSignVersions() || Promise.resolve({})]).then(function (_a) {
                    var hash = _a[0],
                        sender = _a[1],
                        versions = _a[2];
            ...
            function parseInvocationTx(tx, assetsHash, isUTX) {
                ...
                var payment = tx.payment.map(function (payment) {
                    return new data_entities_1.Money(payment.amount, assetsHash[utils_1.normalizeAssetId(payment.assetId)]);
                });
        ...
        }, { "../../sign": 25, "../../utils/utils": 33, "../assets/assets": 4, "../matcher/getOrders": 7, "@waves/bignumber": undefined, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined, "@waves/waves-transactions": undefined, "ramda": undefined }], 15: [function (require, module, exports) {
            "use strict";
            ...
            function list(address, limit, after) {
                ...
                }).then(ramda_1.pipe(ramda_1.prop('0'), ramda_1.uniqBy(ramda_1.prop('id')))).then(function (transactions) {
            ...
            function getExchangeTxList(requestParams, options) {
                ...
                var getData = function getData(response, result) {
                    ...
                    if (!options.getAll) {
                        ...
                        return response.fetchMore().then(function (r) {
                ...
                return request_1.request({
                    method: function method() {
                        return config_1.getDataService().getExchangeTxs(requestParams).then(function (r) {
                            return getData(r, []);
                        });
                    }
        ...
        }, { "../../config": 21, "../../utils/request": 32, "./parse": 14, "@waves/signature-adapter": undefined, "ramda": undefined, "ts-utils": undefined }], 16: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../api/matcher/getOrders": 7, "../config": 21, "../store": 26, "../utils/request": 32, "../utils/utils": 33 }], 17: [function (require, module, exports) {
            "use strict";
            ...
            var DataManager = /** @class */function () {
                ...
                DataManager.prototype.getOracleAssetDataByOracleName = function (id, oracleName) {
                    var _a;
                    if (oracleName === void 0) {
                        oracleName = 'oracleWaves';
                    }
                    ...
                    var gateways = (_a = {}, _a[WavesApp.defaultAssets.USD] = true, _a[WavesApp.defaultAssets.EUR] = true, _a[WavesApp.defaultAssets.TRY] = true, _a[WavesApp.defaultAssets.BTC] = true, _a[WavesApp.defaultAssets.ETH] = true, _a[WavesApp.defaultAssets.LTC] = true, _a[WavesApp.defaultAssets.ZEC] = true, _a[WavesApp.defaultAssets.BCH] = true, _a[WavesApp.defaultAssets.BSV] = true, _a[WavesApp.defaultAssets.DASH] = true, _a[WavesApp.defaultAssets.XMR] = true, _a[WavesApp.defaultAssets.WEST] = true, _a[WavesApp.defaultAssets.ERGO] = true, _a[WavesApp.defaultAssets.BNT] = true, _a);
                    var gatewaysSoon = window.angular.element(document.body).injector().get('configService').get('GATEWAYS_SOON') || [];
                    var descriptionHash = {
        ...
        }, { "../api/aliases/aliases": 3, "../api/assets/assets": 4, "../api/data": 5, "../api/matcher/getOrders": 7, "../config": 21, "../utils/Poll": 31, "./PollControl": 18, "./UTXManager": 20, "@waves/oracle-data": undefined, "ramda": undefined }], 18: [function (require, module, exports) {
            "use strict";
        ...
        }, { "@waves/signature-adapter": undefined, "@waves/waves-transactions": undefined }], 20: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../api/transactions/transactions": 15, "../utils/MoneyHash": 30, "../utils/Poll": 31, "@waves/signature-adapter": undefined }], 21: [function (require, module, exports) {
            "use strict";
        ...
        }, { "./api/node/node": 11, "./utils/request": 32, "@waves/assets-pairs-order": 35, "@waves/data-service-client-js": 40, "ts-utils": undefined }], 22: [function (require, module, exports) {
            "use strict";
            ...
            var request_1 = require("../utils/request");
            var utils_1 = require("../utils/utils");
            var HttpConnectProvider = /** @class */function () {
                function HttpConnectProvider(options) {
                    this.options = options;
                    this.active = true;
                }
                HttpConnectProvider.prototype.send = function (data, options) {
                    if (options === void 0) {
                        options = {};
                    }
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    this.checkActive();
                                    _a = options.timeout, timeout = _a === void 0 ? 1000 : _a, _b = options.attempts, attempts = _b === void 0 ? 1 : _b;
                                    i = attempts;
                                    _c.label = 1;
                                case 1:
                ...
                HttpConnectProvider.prototype.listen = function (cb) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.checkActive();
                                    this.server = window.SimpleConnect.listen(this.options.port, cb);
                                    if (!this.options.ttl) return [3 /*break*/, 2];
                                    return [4 /*yield*/, utils_1.delay(this.options.ttl)];
                                case 1:
                                    _a.sent();
                                    this.server.close();
                                    _a.label = 2;
                ...
                HttpConnectProvider.prototype.destroy = function () {
                    this.active = false;
                    if (this.server) {
                        this.server.close();
                    }
                };
                HttpConnectProvider.prototype.checkActive = function () {
                    if (!this.active) {
                        throw new Error('Provider was destroyed');
                    }
                };
                return HttpConnectProvider;
            }();
            exports.HttpConnectProvider = HttpConnectProvider;
        }, { "../utils/request": 32, "../utils/utils": 33 }], 23: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../utils/utils": 33, "@waves/waves-browser-bus": 57 }], 24: [function (require, module, exports) {
            "use strict";
            ...
            var signature_adapter_1 = require("@waves/signature-adapter");
            var HttpConnectProvider_1 = require("./connect/HttpConnectProvider");
            var PostMessageConnectProvider_1 = require("./connect/PostMessageConnectProvider");
            ...
            exports.utils = __assign({}, utilsModule, { downloadFile: DownloadFile_1.downloadFile, abortDownloading: DownloadFile_1.abortDownloading });
            exports.signature = __assign({}, sign);
            exports.connect = {
                HttpConnectProvider: HttpConnectProvider_1.HttpConnectProvider,
                PostMessageConnectProvider: PostMessageConnectProvider_1.PostMessageConnectProvider
            };
            ...
            var App = /** @class */function () {
                function App() {}
                Object.defineProperty(App.prototype, "address", {
                    get: function get() {
            ...
            exports.app = new App();
        }, { "./api/API": 1, "./api/pairs/pairs": 12, "./broadcast/broadcast": 16, "./classes/DataManager": 17, "./classes/Seed": 19, "./config": 21, "./connect/HttpConnectProvider": 22, "./connect/PostMessageConnectProvider": 23, "./sign": 25, "./store": 26, "./utils/AssetStorage": 27, "./utils/DownloadFile": 29, "./utils/request": 32, "./utils/utils": 33, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined }], 25: [function (require, module, exports) {
            "use strict";
        ...
        }, { "@waves/signature-adapter": undefined }], 26: [function (require, module, exports) {
            "use strict";
        ...
        }, { "./utils/utils": 33, "ramda": undefined }], 27: [function (require, module, exports) {
            "use strict";
        ...
        }, { "./utils": 33, "@waves/data-entities": undefined }], 28: [function (require, module, exports) {
            "use strict";
            ...
            var ConfigService = /** @class */function () {
                ...
                ConfigService.prototype.fetchConfig = function () {
                    var _this = this;
                    return Promise.all([this._getConfig().then(function (config) {
                        return _this._setConfig(config);
                    }), this._getFeeConfig().then(function (config) {
                        return _this._setFeeConfig(config);
                    })]);
                };
                ConfigService.prototype._getConfig = function () {
                    var _this = this;
                    return __1.fetch(this.wavesApp.network.featuresConfigUrl).then(function (data) {
                        if (typeof data === 'string') {
                            return JSON.parse(data);
                        }
                        return data;
                    }).catch(function () {
                        return Promise.resolve(_this.wavesApp.network.featuresConfig);
                    });
                };
                ConfigService.prototype._getFeeConfig = function () {
                    var _this = this;
                    return __1.fetch(this.wavesApp.network.feeConfigUrl).then(this.wavesApp.parseJSON).then(ConfigService.parseFeeConfig).catch(function () {
                        return Promise.resolve(_this.wavesApp.network.feeConfig);
                    });
                };
                ...
                ConfigService.prototype._setConfig = function (config) {
                    ...
                    this.config = config;
                    ConfigService.getDifferencePaths(myConfig, config).forEach(function (path) {
                        return _this.change.dispatch(String(path));
                    });
                };
                ConfigService.getDifferencePaths = function (previous, next) {
                    var paths = ts_utils_1.getPaths(next);
                    return paths.filter(function (path) {
                        return ts_utils_1.get(previous, path) !== ts_utils_1.get(next, path);
                    }).map(String);
                };
        ...
        }, { "../": 24, "@waves/bignumber": undefined, "ts-utils": undefined }], 29: [function (require, module, exports) {
            "use strict";
            ...
            function downloadFile(url, progressCb) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new Promise(function (resolve) {
                            ...
                            xhr.onload = function () {
                                new Response(xhr.response).arrayBuffer().then(function (buffer) {
            ...
            exports.abortDownloading = abortDownloading;
            ...
            exports.Poll = Poll;
        }, { "ts-utils": undefined }], 32: [function (require, module, exports) {
            "use strict";
                    ...
                    promise = fetch(utils_1.normalizeUrl(params.url), params.fetchOptions || Object.create(null)).then(function (response) {
                        ...
                        if (response.ok) {
                            ...
                            if (response.status >= 500 && response.status <= 599) {
                                return response.text().then(tryParseError).then(function (error) {
            ...
            function addDefaultRequestParams(url, options) {
                ...
                if (url.indexOf(config_1.get('node')) === 0 && ts_utils_1.isEmpty(options.credentials)) {
                    options.credentials = 'omit';
                }
                return options;
            }
        }, { "../config": 21, "./utils": 33, "ts-utils": undefined }], 33: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../api/assets/assets": 4, "../config": 21, "./ConfigService": 28, "@waves/bignumber": undefined, "@waves/data-entities": undefined, "@waves/signature-adapter": undefined }], 34: [function (require, module, exports) {
        ...
        }, { "./arbitrary.json": 34, "./mainnet.json": 36, "./testnet.json": 37, "./utils": 38, "bs58": 65 }], 36: [function (require, module, exports) {
        ...
        }, { "./types": 51, "./utils": 52 }], 40: [function (require, module, exports) {
            "use strict";
        ...
        }, { "./methods/getAliases": 42, "./methods/getAssets": 43, "./methods/getAssetsByTicker": 44, "./methods/getCandles": 45, "./methods/getExchangeTxs": 46, "./methods/getMassTransferTxs": 47, "./methods/getPairs": 48, "./methods/getTransferTxs": 49, "./transform": 50, "./types": 51, "./utils": 52 }], 41: [function (require, module, exports) {
            "use strict";
            ...
            var validateIdList = function validateIdList(idList) {
                return Array.isArray(idList) ? Promise.resolve(idList) : Promise.reject(new Error('ArgumentsError: aliasId should be Array'));
            };
            ...
            var createRequestForIdList = function createRequestForIdList(rootUrl) {
                return function (idList) {
                    return createRequest_1.createRequest(rootUrl + "/aliases/?aliases=" + idList.join(','));
                };
            };
            ...
            var createGetAliases = function createGetAliases(libOptions) {
                return {
                    ...
                    getByIdList: createMethod_1.createMethod({
        ...
        }, { "../createRequest": 39, "../utils": 52, "./createMethod": 41 }], 43: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../createRequest": 39, "../utils": 52, "./createMethod": 41 }], 44: [function (require, module, exports) {
            "use strict";

            Object.defineProperty(exports, "__esModule", { value: true });
            var createMethod_1 = require("./createMethod");
            var createRequest_1 = require("../createRequest");
            var validateTicker = function validateTicker(ticker) {
                return typeof ticker !== 'string' ? Promise.reject(new Error('ArgumentsError: Ticker should be string')) : Promise.resolve(ticker);
            };
            var createRequestForMany = function createRequestForMany(rootUrl) {
                return function (ticker) {
                    return createRequest_1.createRequest(rootUrl + "/assets", { ticker: ticker });
                };
            };
            var createGetAssetsByTicker = function createGetAssetsByTicker(libOptions) {
                return createMethod_1.createMethod({
        ...
        }, { "../createRequest": 39, "./createMethod": 41 }], 45: [function (require, module, exports) {
            "use strict";

            Object.defineProperty(exports, "__esModule", { value: true });
            var createMethod_1 = require("./createMethod");
            var createRequest_1 = require("../createRequest");
            var possibleParams = ['timeStart', 'timeEnd', 'interval', 'matcher'];
            var isCandlesParams = function isCandlesParams(params) {
                return (typeof params === "undefined" ? "undefined" : _typeof(params)) === 'object' && Object.keys(params).every(function (k) {
                    return possibleParams.includes(k);
                });
            };
            var isFilters = function isFilters(filters) {
                return Array.isArray(filters) && filters.length === 3 && typeof filters[0] === 'string' && typeof filters[1] === 'string' && isCandlesParams(filters[2]);
            };
            ...
            var createRequestForCandles = function createRequestForCandles(rootUrl) {
                return function (_a) {
                    var amountAssetId = _a[0],
                        priceAssetId = _a[1],
                        params = _a[2];
                    return createRequest_1.createRequest(rootUrl + "/candles/" + amountAssetId + "/" + priceAssetId, params);
                };
            };
            var createGetCandles = function createGetCandles(libOptions) {
                return createMethod_1.createMethod({
        ...
        }, { "../createRequest": 39, "./createMethod": 41 }], 46: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../createRequest": 39, "./createMethod": 41 }], 47: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../createRequest": 39, "./createMethod": 41 }], 48: [function (require, module, exports) {
            "use strict";
            ...
            var isValidPairsFilters = function isValidPairsFilters(request) {
                return Array.isArray(request) && request.length === 2 && typeof request[0] === 'string' && (Array.isArray(request[1]) ? request[1] : [request[1]]).every(isAssetPair);
            };
            var validateRequest = function validateRequest(matcher) {
                return function (pairs) {
                    var request = [matcher, pairs];
                    return isValidPairsFilters(request) ? Promise.resolve(request) : Promise.reject(new Error('ArgumentsError: AssetPair should be object with amountAsset, priceAsset'));
                };
            };
        ...
        }, { "../createRequest": 39, "./createMethod": 41, "@waves/data-entities": undefined }], 49: [function (require, module, exports) {
            "use strict";
        ...
        }, { "../createRequest": 39, "./createMethod": 41 }], 50: [function (require, module, exports) {
            "use strict";
            ...
            var transformCandle = function transformCandle(data) {
                return data === null ? null : new data_entities_1.Candle(data);
            };
            exports.default = transformer;
        }, { "./types": 51, "./utils": 52, "@waves/data-entities": undefined }], 51: [function (require, module, exports) {
            "use strict";
            ...
            var WindowAdapter = /** @class */function (_super) {
                ...
                function WindowAdapter(listen, dispatch, options) {
                    ...
                    _this.listen.forEach(function (protocol) {
                        return protocol.on('message', _this.onMessage, _this);
                    });
                    return _this;
                }
                ...
                WindowAdapter.prototype.accessEvent = function (event) {
                    if (_typeof(event.data) !== 'object' || event.data.type == null) {
                ...
                WindowAdapter.createSimpleWindowAdapter = function (iframe, options) {
                    ...
                    return this.getIframeContent(iframe).then(function (win) {
                ...
                WindowAdapter.prepareOptions = function (options) {
                    ...
                    var concat = function concat(initialValue) {
                        return function (list) {
                    ...
                    var getCollection = function getCollection(data, initial) {
                        return utils_1.pipe(__1.toArray, concat(initial))(data);
                    };
                ...
                WindowAdapter.getIframeContent = function (content) {
                    ...
                    return new Promise(function (resolve, reject) {
                        content.addEventListener('load', function () {
                            return resolve({ win: content.contentWindow });
                        }, false);
        ...
        }, { "..": 57, "../protocols/WindowProtocol": 58, "../utils/utils": 62, "./Adapter": 53 }], 55: [function (require, module, exports) {
            "use strict";
            ...
            var Bus = /** @class */function () {
                function Bus(adapter, defaultTimeout) {
                    ...
                    this._adapter.addListener(function (data) {
                ...
                Bus.prototype.off = function (name, handler) {
                    ...
                    this._eventHandlers[name] = this._eventHandlers[name].filter(function (info) {
                ...
                Bus.prototype._fireEvent = function (name, value) {
                    ...
                    this._eventHandlers[name] = this._eventHandlers[name].slice().filter(function (handlerInfo) {
                        try {
        ...
        }, { "./adapters/Adapter": 53, "./adapters/WindowAdapter": 54, "./bus/Bus": 55, "./config": 56, "./protocols/WindowProtocol": 58, "./utils": 61 }], 58: [function (require, module, exports) {
            "use strict";
            ...
            exports.WindowProtocol = WindowProtocol;
        }, { "typed-ts-events": 70 }], 59: [function (require, module, exports) {
            "use strict";
            ...
            (function (global) {
                ...
                exports.console = __assign({}, generateConsole(), { getSavedMessages: function getSavedMessages(type) {
                        return storage[type] || [];
                    } });
            }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
        }, { "../../config": 56, "../utils": 62 }], 61: [function (require, module, exports) {
            "use strict";
        ...
        }, { "./UniqPrimitiveCollection": 59, "./console": 60, "./utils": 62 }], 62: [function (require, module, exports) {
            "use strict";
            ...
            function pipe() {
                ...
                return function (data) {
                    return args.reduce(function (acc, cb) {
                        return cb(acc);
                    }, data);
                };
            }
        ...
        }, { "base-x": 63 }], 66: [function (require, module, exports) {
            /*!
            ...
            var EventEmitter = /** @class */function () {
                ...
                EventEmitter.prototype.getActiveEvents = function () {
                    var _this = this;
                    return Object.keys(this._events).filter(function (name) {
                        return _this.hasListeners(name);
                    });
                };
